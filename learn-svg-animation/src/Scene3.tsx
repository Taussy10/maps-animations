...
export const Scene3: React.FC = () => {
  ...
  // Guard eyes looking down at the chest
  const eyeScanX = 6;
  const eyeScanY = 3;

  // Guard baton holding angle (inspecting)
  ...
  // Chest Slide-in Animation (enters from the left, past the guard, stops at the cell entrance)
  const chestSpring = spring({
    frame,
    fps,
    config: {
      damping: 15,
  ...
  // Slides from offscreen (X = -200) to its resting spot (X = 460) near the cell gate
  const chestX = interpolate(chestSpring, [0, 1], [-200, 460]);
  ...
  return (
    ...
    >
      ...
      {/* ========================================================
          ...
          ======================================================== */}
      {/* Hugo stands shifted slightly to the left (90px) to be fully visible */}
      <g
        style={{
      ...
      >
        <g style={{ transform: `translateY(${hugoBob}px)` }}>
          ...
          {/* Face details (Happy smile/curious eyes looking at chest) */}
      ...
      {/* ========================================================
          THE BOOK CHEST (Slides into position near cell entrance)
          ======================================================== */}
      <g style={{ transform: `translateX(${chestX}px)` }}>
        {/* Chest Main Box */}
      ...
      >
        <g style={{ transform: `translateY(${guardBob}px)` }}>
          ...
          <g id="guard-head-group">
            ...
            {/* Guard looking down/right at chest */}
          ...
          {/* Weapon (Baton - held down during inspection) */}
          <g
            style={{
