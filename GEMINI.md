...
## Firstly -> LEAVE EVERYTHING FIRSTLY RED THIS -> DO WHAT I TOLD YOU NOTHING ELSE NO FREEDOM  NO LIBERTY -> and if you really want to do something that I do not told then say me I want to do can I get permission of it
## Secondly -> IF I am using something that will heart the performance and it will lead to flickering, lagging, black, black screen then let me know and say It will affect the performance I think instead we can do this 
## Thirdly -> If ask you something then answer it do not go and start creating and implementing things on your own 
## Fourthly -> Do not run TypeScript compilation 
## 0. AI Instructions
